...
<body>
    ...
    <form action="result.php" method="POST">
        ...
        <input type="color" name="mColor"><br><br>
        Pick-up Time, 17:00-18:00: 
        <input type="time" name="pickup_time" min="17:00" max="18:00" value="17:00"><br>
        Your email:<input type="email" name="mEmail"><br>
        Date of birth:<input type="date" name="mDate"><br>

        Remarks:<textarea name="comment" rows="5" cols="40"></textarea></br>
        <input type="submit" value="送出報名表"><input type="reset">
    </form>
</body>
</html>